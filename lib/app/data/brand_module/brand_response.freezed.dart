...
mixin _$BrandResponse {
  ...
  List<BrandModel> get results => throw _privateConstructorUsedError;
...
class __$$_BrandResponseCopyWithImpl<$Res>
    extends _$BrandResponseCopyWithImpl<$Res>
  ...
  __$$_BrandResponseCopyWithImpl(
      ...
      : super(_value, (v) => _then(v as _$_BrandResponse));

  @override
  _$_BrandResponse get _value => super._value as _$_BrandResponse;
...
class _$_BrandResponse implements _BrandResponse {
  _$_BrandResponse(
      ...
      required final List<BrandModel> results})
      : _results = results;
  ...
  @override
  String toString() {
    return 'BrandResponse(limit: $limit, page: $page, total: $total, totalPages: $totalPages, results: $results)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$_BrandResponseToJson(this);
  }
}
...
abstract class _BrandResponse implements BrandResponse {
  factory _BrandResponse(
      ...
      required final List<BrandModel> results}) = _$_BrandResponse;
